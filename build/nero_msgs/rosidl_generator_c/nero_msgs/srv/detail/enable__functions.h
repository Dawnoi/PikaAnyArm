...
#ifndef NERO_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
#define NERO_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
 ...
 * calls
 * nero_msgs__srv__Enable_Request__init().
...
/**
 * It calls
 * nero_msgs__srv__Enable_Request__fini()
 ...
 * nero_msgs__srv__Enable_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * nero_msgs__srv__Enable_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nero_msgs__srv__Enable_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nero_msgs
...
/**
 * It calls
 * nero_msgs__srv__Enable_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nero_msgs
...
/**
 * It allocates the memory for the array and calls
 * nero_msgs__srv__Enable_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nero_msgs
...
/**
 * It calls
 * nero_msgs__srv__Enable_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NERO_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
