...
#ifndef NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__STRUCT_HPP_
#define NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__nero_msgs__msg__NeroStatusMsg __attribute__((deprecated))
#else
# define DEPRECATED__nero_msgs__msg__NeroStatusMsg __declspec(deprecated)
#endif
...
struct NeroStatusMsg_
{
  using Type = NeroStatusMsg_<ContainerAllocator>;

  explicit NeroStatusMsg_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->joint_7_angle_limit = false;
      ...
      this->communication_status_joint_7 = false;
    }
  }

  explicit NeroStatusMsg_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using _joint_7_angle_limit_type =
    bool;
  _joint_7_angle_limit_type joint_7_angle_limit;
  ...
  using _communication_status_joint_7_type =
    bool;
  _communication_status_joint_7_type communication_status_joint_7;
  ...
  Type & set__joint_7_angle_limit(
    const bool & _arg)
  {
    this->joint_7_angle_limit = _arg;
    return *this;
  }
  ...
  Type & set__communication_status_joint_7(
    const bool & _arg)
  {
    this->communication_status_joint_7 = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nero_msgs::msg::NeroStatusMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nero_msgs__msg__NeroStatusMsg
    std::shared_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nero_msgs__msg__NeroStatusMsg
    std::shared_ptr<nero_msgs::msg::NeroStatusMsg_<ContainerAllocator> const>
  ...
  bool operator==(const NeroStatusMsg_ & other) const
  {
    ...
    if (this->joint_7_angle_limit != other.joint_7_angle_limit) {
      return false;
    }
    ...
    if (this->communication_status_joint_7 != other.communication_status_joint_7) {
      return false;
    }
    return true;
  }
...
using NeroStatusMsg =
  nero_msgs::msg::NeroStatusMsg_<std::allocator<void>>;
...
#endif  // NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__STRUCT_HPP_
