...
#ifndef NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__TRAITS_HPP_
#define NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "joint_7_angle_limit: ";
    rosidl_generator_traits::value_to_yaml(msg.joint_7_angle_limit, out);
    out << ", ";
  }
  ...
  {
    out << "communication_status_joint_7: ";
    rosidl_generator_traits::value_to_yaml(msg.communication_status_joint_7, out);
  }
  out << "}";
...
inline std::string to_yaml(const NeroStatusMsg & msg, bool use_flow_style = false)
{
...
[[deprecated("use nero_msgs::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nero_msgs::msg::NeroStatusMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
  nero_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use nero_msgs::msg::to_yaml() instead")]]
inline std::string to_yaml(const nero_msgs::msg::NeroStatusMsg & msg)
{
  return nero_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<nero_msgs::msg::NeroStatusMsg>()
{
  return "nero_msgs::msg::NeroStatusMsg";
}

template<>
inline const char * name<nero_msgs::msg::NeroStatusMsg>()
{
  return "nero_msgs/msg/NeroStatusMsg";
}

template<>
struct has_fixed_size<nero_msgs::msg::NeroStatusMsg>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<nero_msgs::msg::NeroStatusMsg>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<nero_msgs::msg::NeroStatusMsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NERO_MSGS__MSG__DETAIL__NERO_STATUS_MSG__TRAITS_HPP_
