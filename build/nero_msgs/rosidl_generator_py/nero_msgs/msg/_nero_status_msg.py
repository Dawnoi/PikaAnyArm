...
class Metaclass_NeroStatusMsg(type):
    """Metaclass of message 'NeroStatusMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('nero_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'nero_msgs.msg.NeroStatusMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__nero_status_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__nero_status_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__nero_status_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__nero_status_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__nero_status_msg
...
class NeroStatusMsg(metaclass=Metaclass_NeroStatusMsg):
    """Message class 'NeroStatusMsg'."""
    ...
    _fields_and_field_types = {
        ...
        'communication_status_joint_7': 'boolean',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.joint_7_angle_limit = kwargs.get('joint_7_angle_limit', bool())
        ...
        self.communication_status_joint_7 = kwargs.get('communication_status_joint_7', bool())
    ...
    def __eq__(self, other):
        ...
        if self.joint_6_angle_limit != other.joint_6_angle_limit:
            return False
        if self.joint_7_angle_limit != other.joint_7_angle_limit:
            return False
        ...
        if self.communication_status_joint_6 != other.communication_status_joint_6:
            return False
        if self.communication_status_joint_7 != other.communication_status_joint_7:
            return False
        return True
    ...
    @builtins.property
    def joint_7_angle_limit(self):
        """Message field 'joint_7_angle_limit'."""
        return self._joint_7_angle_limit

    @joint_7_angle_limit.setter
    def joint_7_angle_limit(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'joint_7_angle_limit' field must be of type 'bool'"
        self._joint_7_angle_limit = value
    ...
    @builtins.property
    def communication_status_joint_7(self):
        """Message field 'communication_status_joint_7'."""
        return self._communication_status_joint_7

    @communication_status_joint_7.setter
    def communication_status_joint_7(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'communication_status_joint_7' field must be of type 'bool'"
        self._communication_status_joint_7 = value
