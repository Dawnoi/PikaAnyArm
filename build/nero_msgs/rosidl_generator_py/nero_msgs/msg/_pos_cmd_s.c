...
bool nero_msgs__msg__pos_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nero_msgs.msg._pos_cmd.PosCmd", full_classname_dest, 29) == 0);
  }
  nero_msgs__msg__PosCmd * ros_message = _ros_message;
  {  // x
...
PyObject * nero_msgs__msg__pos_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nero_msgs.msg._pos_cmd");
