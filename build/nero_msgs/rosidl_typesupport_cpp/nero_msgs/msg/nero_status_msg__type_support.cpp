...
static const _NeroStatusMsg_type_support_symbol_names_t _NeroStatusMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nero_msgs, msg, NeroStatusMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nero_msgs, msg, NeroStatusMsg)),
  }
};
...
{
  return &::nero_msgs::msg::rosidl_typesupport_cpp::NeroStatusMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nero_msgs, msg, NeroStatusMsg)() {
  return get_message_type_support_handle<nero_msgs::msg::NeroStatusMsg>();
}
