...
#include "nero_msgs/msg/detail/nero_status_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "nero_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _NeroStatusMsg__ros_msg_type = nero_msgs__msg__NeroStatusMsg;

static bool _NeroStatusMsg__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NeroStatusMsg__ros_msg_type * ros_message = static_cast<const _NeroStatusMsg__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: joint_7_angle_limit
  {
    cdr << (ros_message->joint_7_angle_limit ? true : false);
  }
  ...
  // Field name: communication_status_joint_7
  {
    cdr << (ros_message->communication_status_joint_7 ? true : false);
  }

  return true;
}

static bool _NeroStatusMsg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _NeroStatusMsg__ros_msg_type * ros_message = static_cast<_NeroStatusMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: ctrl_mode
  {
    cdr >> ros_message->ctrl_mode;
  }
  ...
  // Field name: joint_7_angle_limit
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->joint_7_angle_limit = tmp ? true : false;
  }
  ...
  // Field name: communication_status_joint_7
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->communication_status_joint_7 = tmp ? true : false;
  }

  return true;
}  // NOLINT(readability/fn_size)

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nero_msgs
size_t get_serialized_size_nero_msgs__msg__NeroStatusMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name joint_7_angle_limit
  {
    size_t item_size = sizeof(ros_message->joint_7_angle_limit);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name communication_status_joint_1
  ...
  // field.name communication_status_joint_7
  {
    size_t item_size = sizeof(ros_message->communication_status_joint_7);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _NeroStatusMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nero_msgs__msg__NeroStatusMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nero_msgs
size_t max_serialized_size_nero_msgs__msg__NeroStatusMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: communication_status_joint_7
  {
    size_t array_size = 1;
  ...
  if (is_plain) {
    ...
    using DataType = nero_msgs__msg__NeroStatusMsg;
    is_plain =
      (
      offsetof(DataType, communication_status_joint_7) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _NeroStatusMsg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_nero_msgs__msg__NeroStatusMsg(
...
static message_type_support_callbacks_t __callbacks_NeroStatusMsg = {
  "nero_msgs::msg",
  "NeroStatusMsg",
  _NeroStatusMsg__cdr_serialize,
  _NeroStatusMsg__cdr_deserialize,
  _NeroStatusMsg__get_serialized_size,
  _NeroStatusMsg__max_serialized_size
};

static rosidl_message_type_support_t _NeroStatusMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NeroStatusMsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nero_msgs, msg, NeroStatusMsg)() {
  return &_NeroStatusMsg__type_support;
}
