...
#include "nero_msgs/msg/detail/pos_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PosCmd__ros_msg_type = nero_msgs__msg__PosCmd;
...
size_t get_serialized_size_nero_msgs__msg__PosCmd(
  const void * untyped_ros_message,
...
static uint32_t _PosCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nero_msgs__msg__PosCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nero_msgs
size_t max_serialized_size_nero_msgs__msg__PosCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nero_msgs__msg__PosCmd;
    is_plain =
      (
...
static size_t _PosCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nero_msgs__msg__PosCmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nero_msgs, msg, PosCmd)() {
