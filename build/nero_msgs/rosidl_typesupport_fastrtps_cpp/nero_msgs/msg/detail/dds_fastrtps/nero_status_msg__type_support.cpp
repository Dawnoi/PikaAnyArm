...
#include "nero_msgs/msg/detail/nero_status_msg__rosidl_typesupport_fastrtps_cpp.hpp"
#include "nero_msgs/msg/detail/nero_status_msg__struct.hpp"
...
cdr_serialize(
  const nero_msgs::msg::NeroStatusMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nero_msgs::msg::NeroStatusMsg & ros_message)
{
  // Member: ctrl_mode
  cdr >> ros_message.ctrl_mode;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nero_msgs
max_serialized_size_NeroStatusMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nero_msgs::msg::NeroStatusMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nero_msgs::msg::NeroStatusMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nero_msgs::msg::NeroStatusMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NeroStatusMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nero_msgs::msg::NeroStatusMsg *>(
...
static size_t _NeroStatusMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NeroStatusMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NeroStatusMsg__callbacks = {
  "nero_msgs::msg",
  "NeroStatusMsg",
...
static rosidl_message_type_support_t _NeroStatusMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NeroStatusMsg__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_nero_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<nero_msgs::msg::NeroStatusMsg>()
{
  return &nero_msgs::msg::typesupport_fastrtps_cpp::_NeroStatusMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nero_msgs, msg, NeroStatusMsg)() {
  return &nero_msgs::msg::typesupport_fastrtps_cpp::_NeroStatusMsg__handle;
}
