...
#include "nero_msgs/msg/detail/pos_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nero_msgs::msg::PosCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nero_msgs::msg::PosCmd & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nero_msgs::msg::PosCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nero_msgs::msg::PosCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nero_msgs::msg::PosCmd *>(
    untyped_ros_message);
...
{
  return &nero_msgs::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nero_msgs, msg, PosCmd)() {
  return &nero_msgs::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
