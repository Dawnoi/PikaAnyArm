...
#include "nero_msgs/srv/detail/enable__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nero_msgs::srv::Enable_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nero_msgs::srv::Enable_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nero_msgs::srv::Enable_Request *>(
    untyped_ros_message);
...
{
  return &nero_msgs::srv::typesupport_fastrtps_cpp::_Enable_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nero_msgs::srv::Enable_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nero_msgs::srv::Enable_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nero_msgs::srv::Enable_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &nero_msgs::srv::typesupport_fastrtps_cpp::_Enable_Response__handle;
}
...
{
  return &nero_msgs::srv::typesupport_fastrtps_cpp::_Enable__handle;
}
