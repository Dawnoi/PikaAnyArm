...
{
  new (message_memory) nero_msgs::srv::Enable_Request(_init);
}

void Enable_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nero_msgs::srv::Enable_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Enable_Request_message_member_array[1] = {
  {
    ...
    offsetof(nero_msgs::srv::Enable_Request, enable_request),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Enable_Request_message_members = {
  "nero_msgs::srv",  // message namespace
  "Enable_Request",  // message name
  1,  // number of fields
  sizeof(nero_msgs::srv::Enable_Request),
...
{
  return &::nero_msgs::srv::rosidl_typesupport_introspection_cpp::Enable_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nero_msgs, srv, Enable_Request)() {
  return &::nero_msgs::srv::rosidl_typesupport_introspection_cpp::Enable_Request_message_type_support_handle;
}
...
void Enable_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) nero_msgs::srv::Enable_Response(_init);
}

void Enable_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nero_msgs::srv::Enable_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Enable_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nero_msgs::srv::Enable_Response, enable_response),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Enable_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(nero_msgs::srv::Enable_Response),
...
{
  return &::nero_msgs::srv::rosidl_typesupport_introspection_cpp::Enable_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nero_msgs, srv, Enable_Response)() {
  return &::nero_msgs::srv::rosidl_typesupport_introspection_cpp::Enable_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Enable_service_members = {
  "nero_msgs::srv",  // service namespace
  "Enable",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<nero_msgs::srv::Enable>()
...
get_service_type_support_handle<nero_msgs::srv::Enable>()
{
  ...
  auto service_type_support =
    &::nero_msgs::srv::rosidl_typesupport_introspection_cpp::Enable_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nero_msgs, srv, Enable)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<nero_msgs::srv::Enable>();
}
