...
bool nero_msgs__msg__nero_status_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nero_msgs.msg._nero_status_msg.NeroStatusMsg", full_classname_dest, 44) == 0);
  }
  nero_msgs__msg__NeroStatusMsg * ros_message = _ros_message;
  {  // ctrl_mode
  ...
  {  // joint_7_angle_limit
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_7_angle_limit");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->joint_7_angle_limit = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // communication_status_joint_7
    PyObject * field = PyObject_GetAttrString(_pymsg, "communication_status_joint_7");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->communication_status_joint_7 = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of NeroStatusMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nero_msgs.msg._nero_status_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NeroStatusMsg");
  ...
  {  // joint_7_angle_limit
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->joint_7_angle_limit ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "joint_7_angle_limit", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // communication_status_joint_7
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->communication_status_joint_7 ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "communication_status_joint_7", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
