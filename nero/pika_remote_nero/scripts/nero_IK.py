...
class RosOperator(Node):
    ...
    def arm_joint_state_ctrl(self, joint_state):
        self.last_ctrl_arm_joint_state = joint_state[:7]
    ...
    def publishing(self):
        ...
        while rclpy.ok():
            ...
            joint_position = []
            for i in range(7):
                joint_position.append(sol_q[count + i])
    ...
    def init_ros(self):
        ...
        if self.args.lift:
            self.lift_publisher = self.create_publisher(JointState, f'/joint_states_lift', queue_size=1)
